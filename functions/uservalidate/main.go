...
func UserValidateHandler(payload []byte, ctx context.RuntimeContext) (interface{}, error) {
	// parse request body
	...
	user, status, err := handler.UserValidate(token)
	if user == nil {
...
func main() {
	runtime.Register(UserValidateHandler)
}
